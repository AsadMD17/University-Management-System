        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-5 p-0">
                    <img src="../graphics/books.jpg" class="img-fluid" alt="">
                </div>
                <div class="col-lg-7 px-5 pt-5">
                    ...
                    <div class="media d-flex align-items-center">
                        ...
                        <div class="media-body">
                            ...
                            <p class="font-weight-normal text-muted mb-0">Classroom-Admin Panel</p>
                        </div>
                    </div>
                    <form method="POST" action="">
                        <div class="form-row">
                            <div class="col-lg-7">
                                <h6 class="mt-5 mb-2">User Name</h6>
                                <input id="auto-name" type="text" placeholder="User name" name="username" class="form-control my-2 p-4" required>
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="col-lg-7">
...
$obj->autofill("admin_credentials");

if (isset($_POST['submit'])) {
    
    $obj->validate("admin_credentials");
    $conn = null;
}?>